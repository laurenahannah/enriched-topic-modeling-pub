...
if __name__ == "__main__":
    ...
    graphname = sys.argv[1] #'10K_2016-03-13.graph'
    modified_graph_outputname = sys.argv[2] #'10K_2016-03-13graph_remove00.txt'
    input_for_GraphFeatureExplorer = sys.argv[3] #'10K_2016-03-13_remove00_explorer.graph'
